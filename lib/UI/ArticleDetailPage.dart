...
class ArticleDetailPage extends StatefulWidget {
  ...
  @override
  _ProductDetailPageState createState() => _ProductDetailPageState(this.article);
}

class _ProductDetailPageState extends State<ArticleDetailPage> with TickerProviderStateMixin {

  final article;
  _ProductDetailPageState(this.article);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Produit ID:" + article.id.toString(),
          style: TextStyle(
            color: Colors.black,
          ),
        ),
